...
// 顧客提案 評価
define("CLIENT_PROPOSAL_EVALUATION_UNSET", 0); // 未設定
define("CLIENT_PROPOSAL_EVALUATION_S", 1); // S(増員/交代)
define("CLIENT_PROPOSAL_EVALUATION_A", 2); // A(実績あり)
define("CLIENT_PROPOSAL_EVALUATION_B", 3); // B(通常)
define("CLIENT_PROPOSAL_EVALUATION_C", 4); // C(可能性低め)
define("CLIENT_PROPOSAL_EVALUATION_LABELS", [
    CLIENT_PROPOSAL_EVALUATION_UNSET => '未設定',
    CLIENT_PROPOSAL_EVALUATION_S => 'S(増員/交代)',
    CLIENT_PROPOSAL_EVALUATION_A => 'A(実績あり)',
    CLIENT_PROPOSAL_EVALUATION_B => 'B(通常)',
    CLIENT_PROPOSAL_EVALUATION_C => 'C(可能性低め)',
]);
...
// BP調達 評価
define("BP_PROCUREMENT_EVALUATION_UNSET", 0); // 未設定
define("BP_PROCUREMENT_EVALUATION_S", 1); // S(提案したい)
define("BP_PROCUREMENT_EVALUATION_A", 2); // A(親和性高め)
define("BP_PROCUREMENT_EVALUATION_B", 3); // B(通常)
define("BP_PROCUREMENT_EVALUATION_C", 4); // C(二次候補)
define("BP_PROCUREMENT_EVALUATION_LABELS", [
    BP_PROCUREMENT_EVALUATION_UNSET => '未設定',
    BP_PROCUREMENT_EVALUATION_S => 'S(提案したい)',
    BP_PROCUREMENT_EVALUATION_A => 'A(親和性高め)',
    BP_PROCUREMENT_EVALUATION_B => 'B(通常)',
    BP_PROCUREMENT_EVALUATION_C => 'C(二次候補)',
]);
...
// 顧客案件開拓 営業状況
define("CLIENT_BIZ_DEV_SALES_STATUS_APPROACHING", 1); // アプローチ中
define("CLIENT_BIZ_DEV_SALES_STATUS_FIRST_MEETING", 2); // 初回面談
define("CLIENT_BIZ_DEV_SALES_STATUS_PROPOSING", 3); // 提案中
define("CLIENT_BIZ_DEV_SALES_STATUS_NEGOTIATING", 4); // 交渉中
define("CLIENT_BIZ_DEV_SALES_STATUS_CLOSING", 5); // クロージング
define("CLIENT_BIZ_DEV_SALES_STATUS_LABELS", [
    CLIENT_BIZ_DEV_SALES_STATUS_APPROACHING => 'アプローチ中',
    CLIENT_BIZ_DEV_SALES_STATUS_FIRST_MEETING => '初回面談',
    CLIENT_BIZ_DEV_SALES_STATUS_PROPOSING => '提案中',
    CLIENT_BIZ_DEV_SALES_STATUS_NEGOTIATING => '交渉中',
    CLIENT_BIZ_DEV_SALES_STATUS_CLOSING => 'クロージング',
]);

// 顧客案件開拓 事由
define("CLIENT_BIZ_DEV_REASON_UNSET", 0); // 未設定
define("CLIENT_BIZ_DEV_REASON_NO_BUDGET", 1); // 予算不足
define("CLIENT_BIZ_DEV_REASON_COMPETITOR", 2); // 競合他社に決定
define("CLIENT_BIZ_DEV_REASON_CANCELLED", 3); // 案件消滅
define("CLIENT_BIZ_DEV_REASON_CONTACT_CHANGED", 4); // 担当者変更
define("CLIENT_BIZ_DEV_REASON_OTHER", 5); // その他
define("CLIENT_BIZ_DEV_REASON_LABELS", [
    CLIENT_BIZ_DEV_REASON_UNSET => '未設定',
    CLIENT_BIZ_DEV_REASON_NO_BUDGET => '予算不足',
    CLIENT_BIZ_DEV_REASON_COMPETITOR => '競合他社に決定',
    CLIENT_BIZ_DEV_REASON_CANCELLED => '案件消滅',
    CLIENT_BIZ_DEV_REASON_CONTACT_CHANGED => '担当者変更',
    CLIENT_BIZ_DEV_REASON_OTHER => 'その他',
]);

// 顧客案件開拓 状況
define("CLIENT_BIZ_DEV_STATUS_ACTIVE", 1); // 進行中
define("CLIENT_BIZ_DEV_STATUS_WON", 2); // 受注
define("CLIENT_BIZ_DEV_STATUS_LOST", 3); // 失注
define("CLIENT_BIZ_DEV_STATUS_ON_HOLD", 4); // 保留
define("CLIENT_BIZ_DEV_STATUS_LABELS", [
    CLIENT_BIZ_DEV_STATUS_ACTIVE => '進行中',
    CLIENT_BIZ_DEV_STATUS_WON => '受注',
    CLIENT_BIZ_DEV_STATUS_LOST => '失注',
    CLIENT_BIZ_DEV_STATUS_ON_HOLD => '保留',
]);
